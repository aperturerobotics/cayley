...
func (x PrimitiveType) MarshalProtoJSON(s *json.MarshalState) {
	s.WriteEnum(int32(x), PrimitiveType_name)
}
...
func (m *Primitive) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Subject = 0
			m.Subject, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 3:
			...
			m.Predicate = 0
			m.Predicate, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 4:
			...
			m.Object = 0
			m.Object, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 5:
			...
			m.Label = 0
			m.Label, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 6:
			...
			m.Replaces = 0
			m.Replaces, iNdEx, err = protobuf_go_lite.DecodeVarint(dAtA, iNdEx)
			if err != nil {
				return err
			}
		case 8:
