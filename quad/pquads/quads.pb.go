...
func (m *WireQuadRaw) CloneVT() *WireQuadRaw {
	...
	if rhs := m.Subject; rhs != nil {
		r.Subject = slices.Clone(rhs)
	}
	if rhs := m.Predicate; rhs != nil {
		r.Predicate = slices.Clone(rhs)
	}
	if rhs := m.Object; rhs != nil {
		r.Object = slices.Clone(rhs)
	}
	if rhs := m.Label; rhs != nil {
		r.Label = slices.Clone(rhs)
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = slices.Clone(m.unknownFields)
	}
...
func (x *Value) MarshalProtoText() string {
	...
	case *Value_TypedStr:
		...
		if body.TypedStr == nil {
			sb.WriteString((&Value_TypedString{}).MarshalProtoText())
		} else {
	...
	case *Value_LangStr:
		...
		if body.LangStr == nil {
			sb.WriteString((&Value_LangString{}).MarshalProtoText())
		} else {
	...
	case *Value_Time:
		...
		sb.WriteString("time: ")
		if body.Time == nil {
			sb.WriteString((&Value_Timestamp{}).MarshalProtoText())
		} else {
